...
* Technical notes
** DONE Add Webpack
** DONE Add TypeScript for better future proofing
** DONE Stick config in an org file
** DONE TypeScript in emacs
** DONE Fix iOS note-is-a-box bug
** TODO Fix no sound on iOS
** TODO Make webpack copy assets
** DONE Org time tracking
** TODO Change name to "Intuitive Music Theory" ?
